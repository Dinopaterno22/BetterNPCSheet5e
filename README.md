...
There was an issue with BetterRolls for 5e that has also been fixed, as of version v1.4.7 of that module. 


## Installation
1. Copy this link and use it in Foundrys Module Manager to install the Module

    > https://raw.githubusercontent.com/Dinopaterno22/BetterNPCSheet5e/master/betternpcsheet5e/module.json
...
## Contribution
Every line of code was written by Felix Mueller. I just changed a few things that were not working on my current setup. 

Shoutout to DestinyGrey#2890 who incentivized the creation of this module.

If you feel like supporting Felix's work, feel free to leave a tip at my paypal felix.mueller.86@web.de
